...
import { getproductAll, removeproduct } from "../../../aip/product";
...
const AdminProducts = {
        ...
        <tbody>
            <tr class = "border">
                ...
                <td class = "border text-center">${list.price}</td>
                <td class = "border text-center">${list.status}</td>
                <td class = "border">${list.desc}</td>
                <td class = "border text-center ">
                    <a class = "btn btn-reomve px-6 py-4 text-white rounded bg-red-500 hover:bg-red-800" href="/#/admin/products/${list.id}/edit">Edit</a> 
